  ...
  <div class="player" v-show="playList.length > 0">
    <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle" @touchstart.prevent="touchstartFn" @touchmove.prevent="touchmoveFn" @touchend="touchendFn">
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" :class="cdCls">
                <img :src="currentSong.image" alt="" class="image" @touchstart.prevent="albumBg(currentSong.image)">
              </div>
            </div>
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="disableCls">
              <i class="icon-prev" @click="prevFn"></i>
            </div>
            <div class="icon i-center" :class="disableCls">
              <i @click="togglePlay" :class="playIcon"></i>
            </div>
            <div class="icon i-right" :class="disableCls">
              <i class="icon-next" @click="nextFn"></i>
            </div>
    ...
    <div class="mini-player" v-show="!fullScreen" @click="openPlayer">
      <div class="icon">
        <img :class="cdCls" :src="currentSong.image" width="100%" height="100%" alt="">
      </div>
      <div class="text">
...
<script>
  ...
  import shuffle from 'common/js/shuffle.js'
  ...
  export default {
    ...
    methods: {
      ...
      _getLyricList() {
        this.currentSong._getLyric().then((suc) => {
          this.currentLyric = new Lyric(suc, this.callback_lyric)
          if (this.playing) {
    ...
    watch: {
      currentTime(newVal) {
        // if (newVal >= this.currentSong.duration) {
        //   this.
        // }
      },
